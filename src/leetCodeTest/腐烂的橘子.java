...
public class 腐烂的橘子 {
     ...
     * dis[x][y] 其实是以这个超级源点的腐烂橘子为起点的广度优先搜索得到的结果。
     *
     * 为了确认是否所有新鲜橘子都被腐烂，可以记录一个变量 cnt 表示当前网格中的新鲜橘子数，
     * 广度优先搜索的时候如果有新鲜橘子被腐烂，则 cnt-=1 ，最后搜索结束时如果 cnt 大于 0 ，
     * 说明有新鲜橘子没被腐烂，返回 -1 ，否则返回所有新鲜橘子被腐烂的时间的最大值即可，
     * 也可以在广度优先搜索的过程中把已腐烂的新鲜橘子的值由 1 改为 2，最后看网格中是否由值为 1 即新鲜的橘子即可。
     *
     * @param grid
     * @return
     */
